...
Confirmatory paper values should be copied only from a complete Narval run
after `jobs/narval/aggregate.sh` has validated every expected shard and written
